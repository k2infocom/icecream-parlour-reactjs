        ...
        <>
            <div className="h-[80px] flex justify-between items-center px-[12%] py-[0] relative">
                <div className="flex items-center justify-center">
                    <span className="text-2xl text-red-600 font-medium cursor-pointer">ICEPARLOR</span>
                </div>
                ...
                <div ref={menu} className="md:static absolute top-[100%] left-[-100%] md:left-[0%] z-999 gap-[20px] w-full transition-all duration-600 bg-white md:bg-[#ffded1]">
                    <ul className="w-full flex flex-col md:flex-row gap-[15px] justify-center">
                        <li className="nav-wrapper"><a href="#home" className="Nav-link">Home</a></li>
                        <li className="nav-wrapper"><a href="#category" className="Nav-link">Category</a></li>
                        <li className="nav-wrapper"><a href="#popular" className="Nav-link">Popular</a></li>
                        <li className="nav-wrapper"><a href="#shop" className="Nav-link">Shop</a></li>
                        <li className="nav-wrapper"><a href="#testimonials" className="Nav-link">Testimonials</a></li>
                    </ul>
                </div>
